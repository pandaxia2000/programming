...
cwd=os.getcwd()
server='ynyfzbmuwbtztgkvlvsb'
source='\Scripts\\'+server+'\\'+'\\ca124\\'
outputfilepath = '\\'
now = time.strftime("%Y-%m-%d-%H_%M_%S",time.localtime(time.time())) 
current_date = (datetime.datetime.now().replace(day=1)-datetime.timedelta(days=1)).strftime("%B %Y")
...
# database connection
def connectdatabase():
     server = 'ynyfzbmuwbtztgkvlvsb.0b49638d68b0.database.chinacloudapi.cn'
     database = 'tempdb'
     username = 'btsadmin'
     password = 'inhVU0E@C*vcbuTW'
...
passwd = '123456'
receivers = ['kevin.chen1@abbott.com','shirley.chen1@abbott.com','ruby.yang@abbott.com','weilan.yang@abbott.com','peng.wang1@abbott.com','alexandre.song@abbott.com','henry.li@abbott.com','jifeng.cao@abbott.com','yunyun.ji@abbott.com','hong.chen2@abbott.com']
...
The  audit logs of '''+server+''' has been enclosed as attachment for your visibility. Thank you.
