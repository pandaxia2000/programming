...
# database connection
def connectdatabase():
     server = 'abtcn-bts-mi-olap-a.0b49638d68b0.database.chinacloudapi.cn'
     database = 'tempdb'
     username = 'btsadmin'
...
passwd = '123456'
receivers = ['xiaoqin.li4@abbott.com','weilan.yang@abbott.com','alexandre.song@abbott.com']
