...
# database connection
def connectdatabase():
     server = 'zgvpy83dgvdkjno.oneabbott.com'
     database = 'tempdb'
     username = 'btsadmin'
     password = 'so*sfAGhSUEq^s8m'
...
receivers = ['yunyun.ji@abbott.com']
...
The  audit logs report of '''+server+''' has been enclosed as attachment for your visibility. Thank you.
