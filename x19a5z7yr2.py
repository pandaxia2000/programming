...
def connectdatabase(databasename):
     server = 'x19a5z7yr2.database.chinacloudapi.cn'
     database = databasename
     username = 'abtcrmadmin'
     password = 'PassWord1325!@'
...
try:
   ...
   from fn_get_audit_file('http://blob/xxx',default,default)
...
try:
     ...
     '''
     sql='''
     select distinct a.action_id from sys.dm_audit_actions a 
     '''
     statement='''
