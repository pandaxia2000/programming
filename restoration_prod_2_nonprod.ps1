...
$SourceDBInstanceId='rm-uf6512iegrt67z10h'
$DestinationDBInstanceId='rm-uf6fw0et9abaa000z'
...
$SourceDatabaseName='yonbipdb'
$DestinationDatabaseName='testdb1117'
...
set_configuration_non_prod
aliyun rds GrantAccountPrivilege --region $region --DBInstanceId $DestinationDBInstanceId --AccountName preprod_oper --DBName $DestinationDatabaseName --AccountPrivilege DBOwner
while ($? -eq $false)
{
aliyun rds GrantAccountPrivilege --region $region --DBInstanceId $DestinationDBInstanceId --AccountName preprod_oper --DBName $DestinationDatabaseName --AccountPrivilege DBOwner
aliyun rds GrantAccountPrivilege --region $region --DBInstanceId $DestinationDBInstanceId --AccountName wangyibiao --DBName $DestinationDatabaseName --AccountPrivilege DBOwner
sleep 10
}
