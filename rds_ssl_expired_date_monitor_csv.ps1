...
$allFiles=get-childitem -path $filePath | Where-Object { $_.Name -match '^rds_SSL_expiration_date_.*\.csv' } 
...
$outputexcelfilename="rds_SSL_expiration_date_"+$todaydate+".csv"
...
$e1 | export-csv ./$outputexcelfilename -Append


#$f2 | Format-Table -AutoSize -Wrap | out-file ./rds_backup_logs.txt -Append -Width 1000
$e2 | export-csv ./$outputexcelfilename -Append
